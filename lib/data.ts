...
export interface ChickenDetail extends ChickenBreed {
  subTitle: string;
  status: 'Còn hàng' | 'Hết hàng' | 'Liên hệ';
...
export const chickensDetailData: Record<string, ChickenDetail> = {
  serama: {
    id: 'serama',
    name: 'Gà Serama',
  ...
  tanchau: {
    ...
    longDescription: 'Gà Tre Tân Châu là dòng gà kiểng thuần chủng của Việt Nam, nổi danh khắp thế giới nhờ bộ lông mã dài thướt tha, bờm cổ dày dặn ôm trọn cơ thể và khả năng thích nghi khí hậu tuyệt đối. Đây là biểu tượng tự hào của giới chơi gà cảnh Việt.',
